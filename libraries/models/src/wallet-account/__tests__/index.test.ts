...
test('walletAccount', () => {
  ...
  expect(() => {
    new WalletAccount({ index: 0 } as never)
  ...
  expect(() => {
    new WalletAccount({ source: 'blahblah' as never, index: 0 })
  }).toThrow('expected option "id" for a non-software wallet account')
  expect(() => {
    new WalletAccount({ source: 'blahblah' as never, index: 0, id: 0 })
  }).toThrow('expected option "id" for a non-software wallet account')
  expect(() => {
