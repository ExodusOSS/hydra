...
import { orderSetFromJSONLegacy, orderSetToJSONLegacy } from '../util.js'
...
const fixture = [
  {
    ...
    svc: 'ch',
    txIds: [{ type: 'cleanup', txId: 'cleanup-tx-id' }],
    potentialToTxIds: [],
  },
]

test('can create an order', () => {
  const orders = orderSetFromJSONLegacy(fixture, { assets })
  const legacy = orderSetToJSONLegacy(orders)
