...
import { utxosFixture1, utxosFixture2, utxosFixture3, utxosFixtureBitcoin } from './fixtures.js'
...
test('merge utxos 3 times', () => {
  ...
  expect(firstMerge.utxos.toArray().map((utxo: any) => utxo.txId)).toEqual([
  ...
  expect(secondMerge.utxos.toArray().map((utxo: any) => utxo.txId)).toEqual([
    'a7fb7cd7a58d5cf8c76485fc1b4151ae139f33d9d0911a95a0c0be540734de5d',
  ])
  ...
  expect(thirdMerge.utxos.toArray().map((utxo: any) => utxo.txId)).toEqual([
...
test('merge tokenUtxos 3 times', () => {
  ...
  expect(firstMerge.tokenUtxos.cardano.toArray().map((utxo: any) => utxo.txId)).toEqual([
    'a7fb7cd7a58d5cf8c76485fc1b4151ae139f33d9d0911a95a0c0be540734de5d',
    '7de99b2367587e121f08e2a95150fbd0939158358181f0a6c3dcd935ac5c0399',
  ])
  ...
  expect(secondMerge.tokenUtxos.cardano.toArray().map((utxo: any) => utxo.txId)).toEqual([
    'a7fb7cd7a58d5cf8c76485fc1b4151ae139f33d9d0911a95a0c0be540734de5d',
  ])
  ...
  expect(thirdMerge.tokenUtxos.cardano.toArray().map((utxo: any) => utxo.txId)).toEqual([
    '17fb7cd7a58d5cf8c76485fc1b4151ae139f33d9d0911a95a0c0be540734de5d',
    '2de99b2367587e121f08e2a95150fbd0939158358181f0a6c3dcd935ac5c0399',
  ])
})
...
test('merge tokenUtxos 3 times using different tokens', () => {
  ...
  expect(secondMerge.tokenUtxos.bitcoin.toArray().map((utxo: any) => utxo.txId)).toEqual([
  ...
  expect(thirdMerge.tokenUtxos.bitcoin.toArray().map((utxo: any) => utxo.txId)).toEqual([
    'AAfb7cd7a58d5cf8c76485fc1b4151ae139f33d9d0911a95a0c0be540734de5d',
    'BBe99b2367587e121f08e2a95150fbd0939158358181f0a6c3dcd935ac5c0399',
  ])
})
