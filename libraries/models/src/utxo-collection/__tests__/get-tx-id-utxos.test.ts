...
test('get utxos associated with tx id', function (t) {
  ...
  t.is(utxosWithTxId0.value.toDefaultString({ unit: true }), '4 BTC', 'total value')
  ...
  t.is(utxosWithTxId1.value.toDefaultString({ unit: true }), '6 BTC')
  ...
  t.is(utxosWithTxId2.value.toDefaultString({ unit: true }), '5 BTC')
