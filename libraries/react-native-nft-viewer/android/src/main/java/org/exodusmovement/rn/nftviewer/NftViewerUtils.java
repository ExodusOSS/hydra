...
public class NftViewerUtils extends ReactContextBaseJavaModule {
  public static final String NAME = "RNNFTUtils";

  ReactApplicationContext mCallerContext;

  public NftViewerUtils(ReactApplicationContext reactContext) {
    super(reactContext);
