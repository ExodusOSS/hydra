...
Decimal.config({ ERRORS: false, DECIMAL_PLACES: 20, precision: 20, EXPONENTIAL_AT: 50 })
...
export default class NumberUnit {
  ...
  floor() {
    return new NumberUnit(this._number.floor(), this.unit, { strict: this.strict })
  }

  round() {
    return new NumberUnit(this._number.round(), this.unit, { strict: this.strict })
  }

  ceil() {
    return new NumberUnit(this._number.ceil(), this.unit, { strict: this.strict })
  }
