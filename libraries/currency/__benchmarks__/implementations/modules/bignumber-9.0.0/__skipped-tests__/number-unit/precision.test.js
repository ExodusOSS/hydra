...
test('20 decimals maximum precision', function() {
  const long = bitcoin.BTC('1.00000000010000000002555')

  assert.strictEqual(
    long.toString(),
    '1.00000000010000000002555 BTC',
    'accepts more than 20 decimals'
  )
  assert.strictEqual(
    long.add(one).toString(),
    '2.00000000010000000003 BTC',
    'rounds at 20 decimals after operations'
  )
})
