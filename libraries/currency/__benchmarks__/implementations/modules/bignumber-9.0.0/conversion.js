...
export default function conversion(numberUnit1, numberUnit2) {
  ok(
    isNumberUnit(numberUnit1) && isNumberUnit(numberUnit2),
    'Must pass in an instance of NumberUnit for both parameters.'
  )
