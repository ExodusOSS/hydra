const _number = (value) => new Intl.NumberFormat('es-US').format(value)

const currency = (value, { currency } = {}) =>
  new Intl.NumberFormat('es-US', { style: 'currency', currency }).format(value)
...
export const percent = (value) => {
  ...
  return new Intl.NumberFormat('es-US', option).format(value)
}
...
export const date = (value) => new Intl.DateTimeFormat('es-ES').format(value)
