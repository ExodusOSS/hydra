...
describe('Address Test', () => {
  describe('Address Recognition Functions', () => {
    ...
    it('Classify if a given address is a P2PKH address correctly', () => {
      ...
      // Assert
      expect(p2pkhMainnetResult).toBeTruthy()
      expect(p2pkhTestnetResult).toBeTruthy()
      expect(p2pkhTestnetIIResult).toBeTruthy()
      expect(p2shMainnetResult).toBeFalsy()
      expect(p2shTestnetResult).toBeFalsy()
      expect(p2wpkhMainnetResult).toBeFalsy()
      expect(p2wpkhTestnetResult).toBeFalsy()
      expect(p2wshMainnetResult).toBeFalsy()
      expect(p2wshTestnetResult).toBeFalsy()
      expect(p2trMainnetResult).toBeFalsy()
      expect(p2trTestnetResult).toBeFalsy()
    })
    ...
    it('Classify if a given address is a P2SH address correctly', () => {
      ...
      // Assert
      expect(p2pkhMainnetResult).toBeFalsy()
      expect(p2pkhTestnetResult).toBeFalsy()
      expect(p2pkhTestnetIIResult).toBeFalsy()
      expect(p2shMainnetResult).toBeTruthy()
      expect(p2shTestnetResult).toBeTruthy()
      expect(p2wpkhMainnetResult).toBeFalsy()
      expect(p2wpkhTestnetResult).toBeFalsy()
      expect(p2wshMainnetResult).toBeFalsy()
      expect(p2wshTestnetResult).toBeFalsy()
    ...
    it('Classify if a given address is a P2WPKH address correctly', () => {
      ...
      expect(p2shMainnetResult).toBeFalsy()
      expect(p2shTestnetResult).toBeFalsy()
      expect(p2wpkhMainnetResult).toBeTruthy()
      expect(p2wpkhTestnetResult).toBeTruthy()
      expect(p2wshMainnetResult).toBeFalsy()
      expect(p2wshTestnetResult).toBeFalsy()
      expect(p2trMainnetResult).toBeFalsy()
      expect(p2trTestnetResult).toBeFalsy()
    ...
    it('Classify if a given address is a P2TR address correctly', () => {
      ...
      expect(p2wshMainnetResult).toBeFalsy()
      expect(p2wshTestnetResult).toBeFalsy()
      expect(p2trMainnetResult).toBeTruthy()
      expect(p2trTestnetResult).toBeTruthy()
    })
  })
  ...
  describe('Witness Stack Recognition Functions', () => {
    ...
    const witnessP2WPKH = [
      Buffer.from(
        '3045022100a611fcb4be51f4866e0386f44fdd83498735dd5ff37aa447ffc6243834804d1502202cf5cda352a887e0b02642492471268ecd9cb1e4ac489d047bf92838e14aaece01',
        'hex'
      ),
    ...
    const witnessP2WSH = [
      Buffer.from(
        '3045022100c931f9c01fe6f4e4f67c55644764659289d8d4cc723fe82dd2b97fbfda064bec02200dfd586f58c9edba874e0cef66e9fe91e7aa7a6cddd6a1f572efb66fe9caef2e01',
        'hex'
      ),
    ...
    const witnessSingleKeyP2TR = [
      Buffer.from(
        'f49ad81e2e586e5ad101da9c00d59fdd7397833329e5a2c5b819fb864a1f25529044df246ed045c76bbbcc39ab6739f75e17d6f85722737e20c145f9aa96338e',
        'hex'
      ),
    ]
    ...
    const witnessScriptP2TR = [
      Buffer.from(
        '187d52d4ed44698ecc962ed74d7f822820475a7567c15bbad8f91ce96d0f132d2d13e43079ae700119c91a46208c995e3a18b5366368dd04450c3ff565221d2c',
        'hex'
      ),
      Buffer.from(
        '205de8154e70d6af52906a4c4d7898b0180de5db8b7cd44cbd27cddff7751cebc7ac0063036f7264010118746578742f706c61696e3b636861727365743d7574662d38002a7b2270223a22736e73222c226f70223a22726567222c226e616d65223a2236333132382e73617473227d68',
        'hex'
      ),
    ...
    it('Classify P2WPKH witness stack correctly', () => {
      ...
      // Assert
      expect(witnessP2WPKHResult).toBeTruthy()
      expect(witnessP2WSHResult).toBeFalsy()
      expect(witnessSingleKeyP2TRResult).toBeFalsy()
      expect(witnessScriptP2TRResult).toBeFalsy()
    })
    ...
    it('Classify single-key-spend P2TR witness stack correctly', () => {
      ...
      // Assert
      expect(witnessP2WPKHResult).toBeFalsy()
      expect(witnessP2WSHResult).toBeFalsy()
      expect(witnessSingleKeyP2TRResult).toBeTruthy()
      expect(witnessScriptP2TRResult).toBeFalsy()
    })
  })
  ...
  describe('Address to scriptPubKey Function', () => {
    ...
    // P2PKH
    const p2pkhMainnet = '17VZNX1SN5NtKa8UQFxwQbFeFc3iqRYhem'
    const p2pkhMainnetScriptPubKey = Buffer.from(
      '76a91447376c6f537d62177a2c41c4ca9b45829ab9908388ac',
      'hex'
    )
    const p2pkhTestnet = 'mipcBbFg9gMiCh81Kj8tqqdgoZub1ZJRfn'
    const p2pkhTestnetScriptPubKey = Buffer.from(
      '76a914243f1394f44554f4ce3fd68649c19adc483ce92488ac',
      'hex'
    )
    const p2pkhTestnetII = 'n11112Lo13n4GvQhQpDtLY8KH7KNeCVmvw'
    const p2pkhTestnetIIScriptPubKey = Buffer.from(
      '76a914d5b84bc628a0a9fd15a411480198d5a31d1e5c0b88ac',
      'hex'
    )
    // P2SH
    const p2shMainnet = '3EktnHQD7RiAE6uzMj2ZifT9YgRrkSgzQX'
    const p2shMainnetScriptPubKey = Buffer.from(
      'a9148f55563b9a19f321c211e9b9f38cdf686ea0784587',
      'hex'
    )
    const p2shTestnet = '2MzQwSSnBHWHqSAqtTVQ6v47XtaisrJa1Vc'
    const p2shTestnetScriptPubKey = Buffer.from(
      'a9144e9f39ca4688ff102128ea4ccda34105324305b087',
      'hex'
    )
    // P2WPKH
    const p2wpkhMainnet = 'bc1qw508d6qejxtdg4y5r3zarvary0c5xw7kv8f3t4'
    const p2wpkhMainnetScriptPubKey = Buffer.from(
      '0014751e76e8199196d454941c45d1b3a323f1433bd6',
      'hex'
    )
    const p2wpkhTestnet = 'tb1qw508d6qejxtdg4y5r3zarvary0c5xw7kxpjzsx'
    const p2wpkhTestnetScriptPubKey = Buffer.from(
      '0014751e76e8199196d454941c45d1b3a323f1433bd6',
      'hex'
    )
    // P2WSH
    ...
    // P2TR
    const p2trMainnet = 'bc1p000022222333333444444455555555666666666999999999zz9qzagays'
    const p2trMainnetScriptPubKey = Buffer.from(
      '51207bdef5294a546318c635ad6b5ad694a5294a535ad6b5ad6b45294a5294a5108a',
      'hex'
    )
    const p2trTestnet = 'tb1p000273lqsqqfw2a6h2vqxr2tll4wgtv7zu8a30rz4mhree8q5jzq8cjtyp'
    const p2trTestnetScriptPubKey = Buffer.from(
      '51207bdeaf47e08000972bbaba98030d4bffeae42d9e170fd8bc62aeee3ce4e0a484',
      'hex'
    )
    ...
    it('Convert valid Bitcoin address into correct scriptPubKey', () => {
      ...
      // Assert
      expect(p2pkhMainnetConverted).toStrictEqual(p2pkhMainnetScriptPubKey)
      expect(p2pkhTestnetConverted).toStrictEqual(p2pkhTestnetScriptPubKey)
      expect(p2pkhTestnetIIConverted).toStrictEqual(p2pkhTestnetIIScriptPubKey)
      expect(p2shMainnetConverted).toStrictEqual(p2shMainnetScriptPubKey)
      expect(p2shTestnetConverted).toStrictEqual(p2shTestnetScriptPubKey)
      expect(p2wpkhMainnetConverted).toStrictEqual(p2wpkhMainnetScriptPubKey)
      expect(p2wpkhTestnetConverted).toStrictEqual(p2wpkhTestnetScriptPubKey)
      expect(p2wshMainnetConverted).toStrictEqual(p2wshMainnetScriptPubKey)
      expect(p2wshTestnetConverted).toStrictEqual(p2wshTestnetScriptPubKey)
      expect(p2trMainnetConverted).toStrictEqual(p2trMainnetScriptPubKey)
      expect(p2trTestnetConverted).toStrictEqual(p2trTestnetScriptPubKey)
    })
    ...
    it('Throw when handling invalid address', () => {
      ...
      // Act
      const p2pkhMainnetMalformedResult = Address.convertAdressToScriptPubkey.bind(
        Address,
        p2pkhMainnetMalformed
      )
      const p2pkhTestnetMalformedResult = Address.convertAdressToScriptPubkey.bind(
        Address,
        p2pkhTestnetMalformed
      )
      const p2shMainnetMalformedResult = Address.convertAdressToScriptPubkey.bind(
        Address,
        p2shMainnetMalformed
      )
      const p2shTestnetMalformedResult = Address.convertAdressToScriptPubkey.bind(
        Address,
        p2shTestnetMalformed
      )
      const p2wpkhMainnetMalformedResult = Address.convertAdressToScriptPubkey.bind(
        Address,
        p2wpkhMainnetMalformed
      )
      const p2wpkhTestnetMalformedResult = Address.convertAdressToScriptPubkey.bind(
        Address,
        p2wpkhTestnetMalformed
      )
      const p2wshMainnetMalformedResult = Address.convertAdressToScriptPubkey.bind(
        Address,
        p2wshMainnetMalformed
      )
      const p2wshTestnetMalformedResult = Address.convertAdressToScriptPubkey.bind(
        Address,
        p2wshTestnetMalformed
      )
      const p2trMainnetMalformedResult = Address.convertAdressToScriptPubkey.bind(
        Address,
        p2trMainnetMalformed
      )
      const p2trTestnetMalformedResult = Address.convertAdressToScriptPubkey.bind(
        Address,
        p2trTestnetMalformed
      )
      const p2wtfMalformedResult = Address.convertAdressToScriptPubkey.bind(Address, p2wtfMalformed)

      // Assert
      expect(p2pkhMainnetMalformedResult).toThrow() // Throw by bitcoinjs-message library
      expect(p2pkhTestnetMalformedResult).toThrow() // Throw by bitcoinjs-message library
      expect(p2shMainnetMalformedResult).toThrow() // Throw by bitcoinjs-message library
      expect(p2shTestnetMalformedResult).toThrow() // Throw by bitcoinjs-message library
      expect(p2wpkhMainnetMalformedResult).toThrow('Unknown address type')
      expect(p2wpkhTestnetMalformedResult).toThrow('Unknown address type')
      expect(p2wshMainnetMalformedResult).toThrow('Unknown address type')
      expect(p2wshTestnetMalformedResult).toThrow('Unknown address type')
      expect(p2trMainnetMalformedResult).toThrow('Unknown address type')
      expect(p2trTestnetMalformedResult).toThrow('Unknown address type')
      expect(p2wtfMalformedResult).toThrow('Unknown address type')
    })
  })
  ...
  describe('Public Key to Addres Function', () => {
    it('Convert valid public key into correct Bitcoin address', () => {
      ...
      const p2trAddressGeneratedInternalPubKey = Address.convertPubKeyIntoAddress(
        publicKey.subarray(1, 33),
        'p2tr'
      )

      // Assert
      expect(p2pkhAddressGenerated.mainnet).toEqual(p2pkhAddress)
      expect(p2pkhAddressGenerated.testnet).toEqual(p2pkhAddressTestnet)
      expect(p2shAddressGenerated.mainnet).toEqual(p2shAddress)
      expect(p2shAddressGenerated.testnet).toEqual(p2shAddressTestnet)
      expect(p2wpkhAddressGenerated.mainnet).toEqual(p2wpkhAddress)
      expect(p2wpkhAddressGenerated.testnet).toEqual(p2wpkhAddressTestnet)
      expect(p2trAddressGenerated.mainnet).toEqual(p2trAddress)
      expect(p2trAddressGenerated.testnet).toEqual(p2trAddressTestnet)
      expect(p2trAddressGeneratedInternalPubKey.mainnet).toEqual(p2trAddress)
      expect(p2trAddressGeneratedInternalPubKey.testnet).toEqual(p2trAddressTestnet)
    })
    ...
    it('Throw when handling invalid address type', () => {
      ...
      // Assert
      expect(p2wtfAddress).toThrow('Cannot convert public key into unsupported address type.')
    })
  })
})
