...
describe.each([
  { useAutoGeneratedPassword: false, maxExtraSeeds: 2 },
  { useAutoGeneratedPassword: true, maxExtraSeeds: 0 },
  { useAutoGeneratedPassword: true, maxExtraSeeds: 2 },
])(
  'wallet with useAutoGeneratedPassword:$useAutoGeneratedPassword',
  ({ useAutoGeneratedPassword, maxExtraSeeds }) => {
    let now
    ...
    describe('import', () => {
      it.each([
        ...
        [
          'invalid words',
          'cousin rudolf peter jürgen entire dynamic marine expand govern enjoy honey tissue',
