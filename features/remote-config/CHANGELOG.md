...
## [3.2.0](https://github.com/ExodusMovement/exodus-hydra/compare/@exodus/remote-config@3.1.0...@exodus/remote-config@3.2.0) (2025-11-18)

### Features

- feat(remote-config): use safe string for error namespace (#14416)
